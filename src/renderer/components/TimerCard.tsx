...
export const TimerCard = ({ timer, onMinimize }: TimerCardProps) => {
  ...
  return (
    <>
      <div ref={setNodeRef} style={cardStyle} className="timer-card">
        <div className="timer-card__header">
          <button
            className="timer-card__drag-handle"
            {...attributes}
            {...listeners}
        ...
        <div className="timer-card__controls">
          <div className="timer-card__controls-main">
            <button
          ...
          <button
            className="timer-card__delete-btn"
      ...
      {confirmingDelete && (
        ...
        >
          <div className="delete-modal" onClick={(e) => e.stopPropagation()}>
            <span className="delete-modal__title">Excluir cronômetro</span>
